...
This is a brief description of each optional mod along with a link to their CurseForge or Modrinth page. Note that each mod is client-side, they can be added or removed from your modlist whenever you want. 
...
- "Jacket" part of player skins is voxels instead of sheets

### [xaerominimap](https://www.curseforge.com/minecraft/mc-mods/xaeros-minimap)
- Simple minimap mod that works with Xaero's world map
