...
This is a link to where each main mod can be found. This is, in a way, scuffed credits when combined with the optional mods index. It might also be useful for troubleshooting or a less asinine way to look over the modlist.

**NOTE FOR CONTRIBUTORS: ADD ANY MOD YOU ADD TO THE FOLDER TO THIS LIST AS WELL, OR SUFFER MY WRATH.**
...
[Custom Nether Portals](https://www.curseforge.com/minecraft/mc-mods/custom-nether-portals)
